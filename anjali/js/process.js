...
var timestamps = [1528184700, 1528200900, 1528271100, 1528274100,1528357500,1528443900,1528703100,1528719300,1528789500,1528875900,1528962300,1529048700];
...
for (var j = 0; j <timestamps.length; j++){
  var testTime = timestamps[j];
  var rightNow = Math.round((new Date()).getTime() / 1000);

  if ((timestamps[j] - rightNow) < 0){
...
console.log(timestamps[k] + papers[k]);
}
